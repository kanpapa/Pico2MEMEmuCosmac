...
1. VSCodeで`ファイル`→`新しいウインドウ`を開きます。
    ![New window](/docs/raspberry-pi-pico-file-new-window.png)
1. `Gitリポジトリのクローン…`をクリックします。
    ![Git clone](/docs/raspberry-pi-pico-git-clone.png)
1. リポジトリのURLを入力します。
  
    https://github.com/kanpapa/Pico2MEMEmuCosmac.git

    ![Git URL](/docs/raspberry-pi-pico-git-url.png)
